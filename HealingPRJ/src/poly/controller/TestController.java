...
//힐링 서비스 효과평가 끝 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
	 ...
	 * //POI 예제
	 * 
	 * @RequestMapping(value = "excel/testRead") public String
	 * excelTestRead(HttpServletRequest request, HttpServletResponse reponse) throws
	 * Exception { log.info(this.getClass().getName() + ".excelTestRead Start !");
	 * 
	 ...
	 * a.showAll(sList);
	 * 
	 * log.info(this.getClass().getName() + ".excelTestRead End !"); return
	 * "success"; }
	 */
