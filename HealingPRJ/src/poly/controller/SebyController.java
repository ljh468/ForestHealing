...
public class SebyController {
	...
	// 운영결과 페이지 호출 _ 유연준
	@RequestMapping(value = "yearMonth/YearMonthResult")
	...
	@RequestMapping(value = "yearMonth/YearMonthResult2")
	...
	@RequestMapping(value = "yearMonth/YearMonthResult3")
