...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-6 col-lg-offset-2 main">
		...
		<div class="panel panel-default" style="height: 600px;">
			<div class="panel-heading">계정 생성</div>
					...
					<div class="" style="width: 600px; background-color: white">
						<div style="margin: 7%;">
							<div style="text-align: right">
								<p
									style="display: inline-block; color: orangered; font-size: small;">*</p>
								<p style="display: inline-block; font-size: small;">는 필수 입력
									사항입니다.</p>
							</div>
							<!-- 사원번호 입력 -->
							...
							<div class="tab_ln" style="">
								...
								<div class="tab_val" style="">
									<input id="ename" name="ename" type="text" placeholder="이름">
								</div>
							</div>
