	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-6 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">직원 계정 생성</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">계정 생성</h1>
			</div>
		</div><!--/.row-->
					...
					<div class="" style="width:600px; background-color:white">
						<div style="margin: 7%;">
							<div style="text-align:right">
								<p style="display:inline-block;color:orangered; font-size:small;">*</p><p style="display:inline-block; font-size:small;">는 필수 입력 사항입니다.</p>
							</div>
							<!-- 사원번호 입력 -->
							<div class="tab_ln" style="">
								<div class="tab_fld" style="">사원번호<p class="astk">&nbsp;*</p></div>
								<div class="tab_val" style=""><input id="empCode" name="empCode" type="text" placeholder="사원번호"></div>
							</div>
							
							<!-- 이름 입력 -->
							<div class="tab_ln" style="">
								<div class="tab_fld" style="">이 름<p class="astk">&nbsp;*</p></div>
								<div class="tab_val" style=""><input id="ename" name="ename" type="text" placeholder="이름"></div>
							</div>
							
							<!-- 비밀번호 입력 -->
							<div class="tab_ln" style="">
								<div class="tab_fld" style="">비밀번호</div>
								<div class="tab_val" style=""><input name="pwd" id="pwd" type="password" placeholder="비밀번호"></div>
							</div>
							
							<!-- 비밀번호 확인 입력 -->
							<div class="tab_ln" style="">
								<div class="tab_fld" style="">비밀번호 확인</div>
								<div class="tab_val" style=""><input name="pwdChk" id="pwdChk" type="password" placeholder="비밀번호 확인"></div>
							</div>
							
							<!-- 권한 -->
							<div class="tab_ln" style="border-bottom: 1px solid #e1e1e1; margin-bottom: 20px;">
								<div class="tab_fld" style="">권한<p class="astk">&nbsp;*</p></div>
								<div class="tab_val" style="">
									<span style="padding-left: 5px;">
										<input type="radio" id="auth_1" name="auth" style="" checked>
										<label for="radio_auth_1" style="margin-bottom: 0px;font-weight: inherit;">관리자</label>
									</span>
									<span style="padding-left: 10px;">
										<input type="radio" id="auto_2" name="auth" style="">
										<label for="radio_auth_2" style="margin-bottom: 0px;font-weight: inherit;">직원</label>
									</span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-md-12" style="text-align:center;">
								<button type="submit" class="btn btn-md btn-primary" onclick="validAllChk();return false;">수정</button>
								<button type="button" class="btn btn-default btn-md">취소</button>
							</div>
						</div>
					</div>
...
<!-- 		<div style="width:200px; height:300px">sdf</div> -->
	...
	<script>
		...
		function validAllChk() {
			...
			/* 비밀번호 유효성 검사 */
			if(pwd.val().includes('>') || pwd.val().includes('<') || pwd.val().length < 8 || pwd.val().length > 20) {
