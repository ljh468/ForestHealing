					...
					<div class="" style="width:600px; background-color:white">
						<div style="margin: 7%;">
							...
							<div class="tab_ln" style="">
								...
								<div class="tab_val" style=""><input id="empCode" name="empCode" type="text" placeholder="BDH09211"></div>
							</div>
							
							<!-- 이름 입력 -->
							<div class="tab_ln" style="">
								<div class="tab_fld" style="">이 름<p class="astk">&nbsp;*</p></div>
								<div class="tab_val" style=""><input id="ename" name="ename" type="text" placeholder="홍길동"></div>
							</div>
