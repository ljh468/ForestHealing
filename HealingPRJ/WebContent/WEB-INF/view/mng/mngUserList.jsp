...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-default" style="min-height: 700px;">
			<div class="panel-heading" style="height:auto; border-bottom:none; margin-bottom: 3%;">
				<div>직원 계정 목록</div>
				<div class="input-group">
					<input id="btn-input" type="text" class="form-control input-md" placeholder="검색어를 입력하세요" />
			...
			<div class="panel-body">
				<ul class="todo-list">
					...
					<li class="todo-list-item">
						<div class="checkbox" style="width: 10%;">	<!-- 번호 -->
							<label for="">번호</label>
						</div>
						<div class="checkbox" style="width: 20%; margin-right: 20%;">	<!-- 직원명 -->
							<label for="">직원명</label>
						</div>
						<div class="checkbox" style="width: 10%; margin-right: 3%;">	<!-- 권한 -->
							<label for="">권한</label>
						</div>
						<div class="checkbox" style="width: 20%; margin-right: 6%;">	<!-- 가입일자 -->
							<%-- <label for=""><%=uList.get(i).getRegDate()%></label> --%>
							<label for="">가일일자</label>
						</div>
						<div class="checkbox" style="width: 6%; margin-right: 2%;"><label style="padding-left:0px">삭제</label></div>	<!-- 삭제 -->
					</li>
					<li class="todo-list-item" style="padding: 1px 0px 1px 0px; border-top: 1px solid #dddddd; margin: 0px 20px 0px 25px;">
					</li>
					<!-- 홍두표 - 직원 목록 for문 -->
					<%for(int i=0; i < uNameArr.length; i++) { %>
						...
						<%-- <li class="todo-list-item" onclick="userDetail(<%=uList.get(i).getUserNo()%>)"> --%>
							...
							<div class="checkbox" style="width: 20%; margin-right: 20%;">	<!-- 직원명 -->
								...
								<%if(uNameArr[i].substring(0,1).equals("w")) { %>
									<a type="button" class="btn btn-md btn-success agreeWait" data-name="<%=uNameArr[i].substring(1) %>"  style="height: 22px; padding: 1px;">승인대기중</a>	<!-- 승인여부 -->
								<%} %>
								<!-- 홍두표 - 승인 여부 컬럼값으로 조건문 처리 -->
							</div>
							<div class="checkbox" style="width: 10%; margin-right: 3%;">	<!-- 권한 -->
							...
							<div class="checkbox" style="width: 6%; margin-right: 2%;"><a href="#" class="trash"><span class="fa fa-trash"></span></a></div>	<!-- 삭제 -->
						</li>
					<%} %>
					<!-- 홍두표 - 직원 계정 목록 -->
			...
			<!-- 홍두표 - 계정 생성 -->
			<div class="form-group" style="margin-top: 150px; margin-right: 100px;">
				<div class="" style="text-align:right; width:100%;">
					<button type="submit" class="btn btn-md btn-primary" onclick="location.href='/mng/mngCreateUser.do'">계정생성</button>
				</div>
			</div>
	...
	<script>
		$(function(){
			$('.userDetail').click(function(){
				location.href="/mng/mngGetUserDetail.do?userNo="+$(this).attr('data-userNo');
			})
			$('.agreeWait').click(function(){
				$('.userDetail').unbind();
				isAllow = confirm($(this).attr('data-name')+"님의 가입 신청을 승인하시겠습니까?");
				if(isAllow) {
					alert("승인되었습니다.");
				} else {
