...
<%
	...
	List<PreventInsertDTO> pList = (List<PreventInsertDTO>)request.getAttribute("preventList");
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">예방서비스 효과평가 수정</h1>
			</div>
		</div><!--/.row-->
						...
						<div style="height: auto; width: auto;">
							<div style="display: inline-block;">
								...
								<div style="float: left; margin-right: 10px;">
									<input class="form-control form-openday" style="width: 190px;" type="date" name="form-openday" value="<%=convertXSS(pList.get(0).getOpenday())%>">
								</div>
							</div>
							...
							<div style="display: block;">
								...
								<div style="margin-right:10px">
									...
									<div style="float: left; margin-right: 10px;">
										<input class="form-control form-eval_date" style="width: 190px;" type="date" name="form-eval_date" value="<%=convertXSS(pList.get(0).getEval_date())%>">
									</div>
								</div>
								<div style="margin-right:10px">
									...
									<div style="width: 90px; float: left; margin-right: 10px;">
										<div style="width: 90px; float: left; margin-right: 10px;">
											<input class="form-control" name="form-pv" value="<%=convertXSS(pList.get(0).getPv())%>" readonly>
										</div>
									</div>
								</div>
						...
						<div id="parent">
							...
							<div class="insertForm" style="width: 2150px; height: 40px;" name="form-main" id="child<%=i%>">
								...
								<div style="width: 120px; float: left; margin-right: 10px;">
									<input class="form-control" name="form-name" placeholder="이름" value="<%=convertXSS(pList.get(i).getName())%>">
								</div>
								...
								<div style="width: 160px; float: left; margin-right: 5px;">
									<input class="form-control" name="form-pastStress" placeholder="0=미기재/1=무/2=유" value="<%=convertXSS(pList.get(i).getPast_stress_experience())%>">
								</div>
								<%
								// 반복문을 돌려서 문항 개수만큼 문항 만들기
								for(int j = 0; j < groupMargin.length; j++) { %>
								<div style="width: 60px; float: left; margin-right: <%=groupMargin[j]%>px;">
									<input class="form-control" name="form-score<%=j+1 %>" placeholder="점수" value="<%=pList.get(i).getScoreString2List().get(j)%>">
								</div>
								<% } %>
							</div>
							<% }  %>
