	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">힐링서비스 효과평가</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">힐링서비스 효과평가</h1>
			</div>
		</div><!--/.row-->
				...
				<div class="panel panel-default chat">
					...
					<div class="panel-body" style="overflow-x: scroll; height: auto; overflow-y: hidden;">
						...
						<div style="width: 2250px;height: 70px">
							...
							<div style="width: 65px; float: left; margin-right: 10px; text-align: center; -webkit-text-emphasis-style: open;"><h4 class="main-head">성별</h4></div>
							<div style="width: 65px; float: left; margin-right: 10px; text-align: center; -webkit-text-emphasis-style: open;"><h4 class="main-head">연령</h4></div>
							...
							<div style="width: 140px; float: left; margin-right: 10px; text-align: center; -webkit-text-emphasis-style: open;"><h4 class="main-head">직업</h4></div>
							<!--입력양식의 공통부분 -->
						...
						<div id="parent">
							...
							<div class="insertForm" style="width: 2250px; height: 40px;" name="form-main" id="child<%=i%>">
								...
								<div style="width: 160px; float: left; margin-right: 5px;">
									<input class="form-control" name="form-pastStress" placeholder="0=미기재/1=무/2=유">
								</div>
								<%
