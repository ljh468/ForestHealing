	...
	<div class="col-md-12">
		...
		<div style=" display: table-row;  border: 1px solid black;">
			...
			<div style="display: table-cell; width : 305px;">
				<div style=" height: 30px; border-bottom: 1px solid black; background-color: #ccc;">평균(0~6점)</div>
				<div style="display: table-cell;">
					<div style="display: table-cell; width: 51px;height: 45px; border-right: 1px solid black;background-color: #ccc;">중독<br>특징<br>이해</div>
					<div style="display: table-cell; width: 51px;height: 45px; border-right: 1px solid black;background-color: #ccc;">핵짐<br>증상<br>이해</div>
					<div style="display: table-cell; width: 51px;height: 45px; border-right: 1px solid black;background-color: #ccc;">문제<br>대응<br>방법</div>
					<div style="display: table-cell; width: 51px;height: 45px; border-right: 1px solid black;background-color: #ccc;">활동<br>역량</div>
					<div style="display: table-cell; width: 51px;height: 45px; border-right: 1px solid black;background-color: #ccc;">심리적<br>면역력<br>강화법</div>
		...
		<div style="display: table-row;  border: 1px solid black;">
		  	<div style="display: table-cell; width: 50px; height: 40px; border-right: 1px solid black;"><br><%=c_1 %></div>
			<div style="display: table-cell; width: 50px; height: 40px; border-right: 1px solid black;"><br><%=c_2%></div>
			<div style="display: table-cell; width: 50px; height: 40px; border-right: 1px solid black;"><br><%=c_3 %></div>
			<div style="display: table-cell;">
			...
			<div style="display: table-cell;">
				<div style="display: table-cell; width: 50px; height: 40px; border-right: 1px solid black;">
					...
					<div style="line-height:20px; height: 20px"><%=CmmUtil.nvl(rList.get(i).getScore21()) %></div>
				</div>
				<div style="display: table-cell; width: 50px; height: 40px; border-right: 1px solid black;">
					<div style="line-height:20px; height:20px;   border-bottom: 1px solid black"><%=CmmUtil.nvl(rList.get(i).getScore2()) %></div>
					<div style="line-height:20px; height: 20px"><%=CmmUtil.nvl(rList.get(i).getScore22()) %></div>
				</div>
				<div style="display: table-cell; width: 50px; height: 40px; border-right: 1px solid black;">
			...
			<div style="display: table-cell;">
				<div style="display: table-cell; width: 50px; height: 40px; border-right: 1px solid black;">
					<div style="line-height:20px; height:20px; width: 50px;  border-bottom: 1px solid black"><%=CmmUtil.nvl(rList.get(i).getAvg1()) %></div>
					<div style="line-height:20px; height: 20px;width: 50px;"><%=CmmUtil.nvl(rList.get(i).getAvg7()) %></div>
				</div>
				<div style="display: table-cell; width: 50px; height: 40px; border-right: 1px solid black;">
					<div style="line-height:20px; height:20px;width: 50px;   border-bottom: 1px solid black"><%=CmmUtil.nvl(rList.get(i).getAvg2()) %></div>
					<div style="line-height:20px; height: 20px;width: 50px;"><%=CmmUtil.nvl(rList.get(i).getAvg8()) %></div>
				</div>
				<div style="display: table-cell; width: 50px; height: 40px; border-right: 1px solid black;">
					<div style="line-height:20px; height:20px;width: 50px;   border-bottom: 1px solid black"><%=CmmUtil.nvl(rList.get(i).getAvg3()) %></div>
					<div style="line-height:20px; height: 20px;width: 50px;"><%=CmmUtil.nvl(rList.get(i).getAvg9()) %></div>
				</div>
				<div style="display: table-cell; width: 50px; height: 40px; border-right: 1px solid black;">
					<div style="line-height:20px; height:20px;width: 50px;   border-bottom: 1px solid black"><%=CmmUtil.nvl(rList.get(i).getAvg4()) %></div>
					<div style="line-height:20px; height: 20px;width: 50px;"><%=CmmUtil.nvl(rList.get(i).getAvg10()) %></div>
				</div>
				<div style="display: table-cell; width: 50px; height: 40px; border-right: 1px solid black;">
					<div style="line-height:20px; height:20px;width: 50px;   border-bottom: 1px solid black"><%=CmmUtil.nvl(rList.get(i).getAvg5()) %></div>
					<div style="line-height:20px; height: 20px;width: 50px;"><%=CmmUtil.nvl(rList.get(i).getAvg11()) %></div>
				</div>
				<div style="display: table-cell; width: 50px; height: 40px;">
					<div style="line-height:20px; height:20px;width: 50px;   border-bottom: 1px solid black"><%=CmmUtil.nvl(rList.get(i).getAvg6()) %></div>
					<div style="line-height:20px; height: 20px;width: 50px;"><%=CmmUtil.nvl(rList.get(i).getAvg12()) %></div>
				</div>
			</div>
		</div> 
		<%} %>
		<div style="display: table-row;  border: 1px solid black;">
		  	<div style="display: table-cell; width: 50px; height: 40px; border-right: 1px solid black;"><br></div>
			<div style="display: table-cell; width: 50px; height: 40px; border-right: 1px solid black;"><br></div>
			...
			<div style="display: table-cell;">
				...
				<div style="display: table-cell; width: 50px; height: 40px; border-right: 1px solid black;">
					...
					<div style="line-height:20px; height: 20px"><%=Math.round((Double.parseDouble(AvgList.get(0).getScore40())-Double.parseDouble(AvgList.get(0).getScore20()))*100.0)/100.0%></div>
				</div>
			</div>
			<!--영역  -->
			<div style="display: table-cell;">
			...
			<div style="display: table-cell;">
				<div style="display: table-cell; width: 55px; height: 40px; border-right: 1px solid black;">
					<div style="line-height:20px; height:20px;width: 50px;   border-bottom: 1px solid black"><%=CmmUtil.nvl(AvgList.get(0).getAvg1()) %></div>
					<div style="line-height:20px; height:20px; width: 50px;  border-bottom: 1px solid black"><%=CmmUtil.nvl(AvgList.get(0).getAvg7()) %></div>
					<div style="line-height:20px; height: 20px; width: 50px;"><%=Math.round((Double.parseDouble(AvgList.get(0).getAvg7())-Double.parseDouble(AvgList.get(0).getAvg1()))*100.0)/100.0%></div>
				</div>
				<div style="display: table-cell; width: 55px; height: 40px; border-right: 1px solid black;">
					<div style="line-height:20px; height:20px;width: 50px;   border-bottom: 1px solid black"><%=CmmUtil.nvl(AvgList.get(0).getAvg2()) %></div>
					<div style="line-height:20px; height:20px;width: 50px;   border-bottom: 1px solid black"><%=CmmUtil.nvl(AvgList.get(0).getAvg8()) %></div>
					<div style="line-height:20px; height: 20px; width: 50px;"><%=Math.round((Double.parseDouble(AvgList.get(0).getAvg8())-Double.parseDouble(AvgList.get(0).getAvg2()))*100.0)/100.0%></div>
				</div>
				<div style="display: table-cell; width: 55px; height: 40px; border-right: 1px solid black;">
					<div style="line-height:20px; height:20px;width: 50px;   border-bottom: 1px solid black"><%=CmmUtil.nvl(AvgList.get(0).getAvg3()) %></div>
					<div style="line-height:20px; height:20px;width: 50px;   border-bottom: 1px solid black"><%=CmmUtil.nvl(AvgList.get(0).getAvg9()) %></div>
					<div style="line-height:20px; height: 20px;width: 50px;"><%=Math.round((Double.parseDouble(AvgList.get(0).getAvg9())-Double.parseDouble(AvgList.get(0).getAvg3()))*100.0)/100.0%></div>
				</div>
				<div style="display: table-cell; width: 55px; height: 40px; border-right: 1px solid black;">
					<div style="line-height:20px; height:20px;width: 50px;   border-bottom: 1px solid black"><%=CmmUtil.nvl(AvgList.get(0).getAvg4()) %></div>
					<div style="line-height:20px; height:20px; width: 50px;  border-bottom: 1px solid black"><%=CmmUtil.nvl(AvgList.get(0).getAvg10()) %></div>
					<div style="line-height:20px; height: 20px;width: 50px;"><%=Math.round((Double.parseDouble(AvgList.get(0).getAvg10())-Double.parseDouble(AvgList.get(0).getAvg4()))*100.0)/100.0%></div>
				</div>
				<div style="display: table-cell; width: 55px; height: 40px; border-right: 1px solid black;">
					<div style="line-height:20px; height:20px;width: 50px;   border-bottom: 1px solid black"><%=CmmUtil.nvl(AvgList.get(0).getAvg5()) %></div>
					<div style="line-height:20px; height:20px;width: 50px;   border-bottom: 1px solid black"><%=CmmUtil.nvl(AvgList.get(0).getAvg11()) %></div>
					<div style="line-height:20px; height: 20px;width: 50px;"><%=Math.round((Double.parseDouble(AvgList.get(0).getAvg11())-Double.parseDouble(AvgList.get(0).getAvg5()))*100.0)/100.0%></div>
				</div>
				<div style="display: table-cell; width: 55px; height: 40px;">
					<div style="line-height:20px; height:20px;width: 50px;   border-bottom: 1px solid black"><%=CmmUtil.nvl(AvgList.get(0).getAvg6()) %></div>
					<div style="line-height:20px; height:20px;width: 50px;   border-bottom: 1px solid black"><%=CmmUtil.nvl(AvgList.get(0).getAvg12()) %></div>
					<div style="line-height:20px; height: 20px;width: 50px;"><%=Math.round((Double.parseDouble(AvgList.get(0).getAvg12())-Double.parseDouble(AvgList.get(0).getAvg6()))*100.0)/100.0%></div>
				</div>
			</div>
		</div> 
