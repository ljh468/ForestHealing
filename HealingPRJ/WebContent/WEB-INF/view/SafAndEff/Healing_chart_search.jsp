...
<body>
   ...
   <div class="col-md-12">
		...
		<div style=" display: table-row;  border: 1px solid black;">
			<div style="display: table-cell; width: 60px; height:60px; border-right: 1px solid black; background-color: #ccc;"><br><br>주제어 1</div>
			<div style="display: table-cell; width: 60px; height: 60px; border-right: 1px solid black;background-color: #ccc;"><br><br>주제어 2</div>
			<div style="display: table-cell; width: 60px; height: 60px; border-right: 1px solid black;background-color: #ccc;"><br><br>주제어 3</div>
			<div style="display: table-cell;">
				<div style="width:auto; height: 30px; border-bottom: 1px solid black; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">영역</p></div>
				<div style="display: table-cell;">
					<div style="display: table-cell; width: 40px; height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">평가<br>시점</p></div>
				</div>
			</div>
			<div style="display: table-cell;">
				<div style="width:auto; height: 30px; border-bottom: 1px solid black; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">1.욕구충족</p></div>
				<div style="display: table-cell;">
					<div style="display: table-cell; width: 40px; height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항1</p></div>
					<div style="display: table-cell; width: 40px; height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항2</p></div>
				</div>
			</div>
			<div style="display: table-cell;">
				<div style="width:auto; height: 30px; border-bottom: 1px solid black; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">2.긍정정서</p></div>
				<div style="display: table-cell;">
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항3</p></div>
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항4</p></div>
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항5</p></div>
				</div>
			</div>
			<div style="display: table-cell;">
				<div style="width:auto; height: 30px; border-bottom: 1px solid black; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">3.자기이해</p></div>
				<div style="display: table-cell;">
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항6</p></div>
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항7</p></div>
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항8</p></div>
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항9</p></div>
				</div>
			</div>
			<div style="display: table-cell;">
				<div style="width:auto; height: 30px; border-bottom: 1px solid black; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">4.마음관리기술</p></div>
				<div style="display: table-cell;">
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항10</p></div>
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항11</p></div>
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항12</p></div>
				</div>
			</div>
			<div style="display: table-cell;">
				<div style="width:auto; height: 30px; border-bottom: 1px solid black; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">5.정서능력측면</p></div>
				<div style="display: table-cell;">
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항1</p></div>
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항2</p></div>
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항3</p></div>
			...
			<div style="display: table-cell;">
				<div style="width:auto; height: 30px; border-bottom: 1px solid black; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">6.영성측면</p></div>
				<div style="display: table-cell;">
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항5</p></div>
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항6</p></div>
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항7</p></div>
			...
			<div style="display: table-cell;">
				<div style="width:auto; height: 30px; border-bottom: 1px solid black; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">7.삶의 조망측면</p></div>
				<div style="display: table-cell;">
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항8</p></div>
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항9</p></div>
					<div style="display: table-cell; width: 40px;height: 52px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">문항10</p></div>
			...
			<div style="display: table-cell;">
				<div style="width:auto; height: 30px; border-bottom: 1px solid black; background-color: #ccc;"><p style="transform: translateY(8px);">평균(0~6)</p></div>
				<div style="display: table-cell;">
					<div style="display: table-cell; width: 40px;height: 45px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">욕구<br>충족</p></div>
					<div style="display: table-cell; width: 40px;height: 45px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">긍정<br>정서</p></div>
					<div style="display: table-cell; width: 40px;height: 45px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">자기<br>이해</p></div>
					<div style="display: table-cell; width: 40px;height: 45px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">마음<br>관리<br>기술</p></div>
					<div style="display: table-cell; width: 40px;height: 45px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">정서<br>능력<br>측면</p></div>
					<div style="display: table-cell; width: 40px;height: 45px; border-right: 1px solid black;background-color: #ccc;"><p style="transform: translateY(8px);">영성<br>측면</p></div>
					<div style="display: table-cell; width: 40px;height: 45px; background-color: #ccc;"><p style="transform: translateY(8px);">삶의<br>조망<br>측면</p></div>
				</div>
			</div>
		</div>
		<%for (int i=0; i<rList.size(); i++){ %>
		<div style="display: table-row;  border: 1px solid black;">
		  	<div style="display: table-cell; width: 60px; height: 40px; border-right: 1px solid black;"><%=c_1 %><br></div>
			<div style="display: table-cell; width: 60px; height: 40px; border-right: 1px solid black;"><%=c_2 %></div>
			<div style="display: table-cell; width: 60px; height: 40px; border-right: 1px solid black;"><%=c_3 %></div>
			<div style="display: table-cell;">
