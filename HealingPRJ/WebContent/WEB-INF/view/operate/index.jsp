					...
					<div class="panel-body">
						...
						<div class="form-horizontal row-border">
							...
							<div class="form-group justify-content-center">
								...
								<div class="col-md-10">
									<select class="form-control input-lg" name="residence"
										id="residence" style="border-radius: 5px;">
							...
							<div class="form-group justify-content-center">
								...
								<div class="col-md-10">
									<label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="support" id="support" value="프로그램">프로그램<span
										class="checkmark"></span>
									</label> <label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="support" id="support" value="숙박">숙박<span
										class="checkmark"></span>
									</label> <label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="support" id="support" value="식사">식사<span
										class="checkmark"></span>
									</label> <label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="support" id="support" value="해당없음">해당없음<span
										class="checkmark"></span>
									</label>
								</div>
							</div>
							...
							<div class="form-group justify-content-center">
								...
								<div class="col-md-10">
									<label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="part_type" id="participant" value="장애인">장애인<span
										class="checkmark"></span>
									</label> <label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="part_type" id="participant" value="가족">가족<span
										class="checkmark"></span>
									</label> <label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="part_type" id="participant" value="저소득">저소득<span
										class="checkmark"></span>
									</label> <label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="part_type" id="participant" value="중독">중독<span
										class="checkmark"></span>
									</label> <label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="part_type" id="participant" value="교직원">교직원<span
										class="checkmark"></span>
									</label> <label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="part_type" id="participant"
							...
							<div class="form-group justify-content-center">
								...
								<div class="col-md-10">
									<label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="age_group" id="age" value="아동">아동<span
										class="checkmark"></span>
									</label> <label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="age_group" id="age" value="청소년">청소년<span
										class="checkmark"></span>
									</label> <label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="age_group" id="age" value="성인">성인<span
										class="checkmark"></span>
									</label> <label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="age_group" id="age" value="노인">노인<span
										class="checkmark"></span>
									</label> 
								</div>
							</div>
							...
							<div class="form-group justify-content-center">
								...
								<div class="col-md-10">
									<label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="service_type" id="service" value="1">산림교육<span
										class="checkmark"></span>
									</label> <label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="service_type" id="service" value="산림치유">산림치유<span
										class="checkmark"></span>
									</label> <label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="service_type" id="service"
										value="행위중독치유">행위중독치유<span class="checkmark"></span>
									</label> <label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="service_type" id="service"
										value="행위중독예방">행위중독예방<span class="checkmark"></span>
									</label> <label class="checkbox-wrap checkbox-success"> <input
										type="radio" name="service_type" id="service" value="힐링">힐링<span
										class="checkmark"></span>
									</label>
								</div>
							</div>
							...
							<div class="form-group justify-content-center">
								...
								<div class="col-md-10">
									...
									<div class="col-md-5" style="display: inline-flex;">
										...
										<div class="col-md-3">
											<input type="text" name="room_part_people"
								...
								<div class="col-md-10">
									...
									<div class="col-md-5" style="display: inline-flex;">
										<label class="col-md-3 control-label">인원</label>
										<div class="col-md-3">
											<input type="text" name="room_lead_people"
								...
								<div class="col-md-10">
									...
									<div class="col-md-5" style="display: inline-flex;">
										<label class="col-md-3 control-label">인원</label>
										<div class="col-md-3">
											<input type="text" name="room_etc_people"
							...
							<div class="form-group justify-content-center">
								...
								<div class="col-md-10">
									...
									style="width: 100px; font-size: 20px; margin-bottom: 10px;">
									</label>
								</div>
							...
							<div class="form-group justify-content-center">
								<label class="col-md-2 control-label">프로그램 만족도 </label> <label
									class="btn btn-default" style="margin-top: 10px;"> <input
									type="file" hidden="" name="program_facility_satisfaction">
								</label>
							...
							<div class="form-group justify-content-center">
								<label class="col-md-2 control-label">시설서비스 만족도 </label> <label
									class="btn btn-default" style="margin-top: 10px;"> <input
									type="file" hidden="" name="facility_satisfaction">
								</label>
								<button type="button" class="btn btn-primary btn-info btn-md"
									style="font-size: 16px; margin-top: 10px;">Upload</button>
							</div>
							...
							<div class="form-group justify-content-center">
								<label class="col-md-2 control-label">상담&치유 서비스<br>효과평가
								</label> <label class="btn btn-default" style="margin-top: 10px;">
							...
							<div class="form-group justify-content-center">
								<label class="col-md-2 control-label">예방서비스<br>효과평가
								</label> <label class="btn btn-default" style="margin-top: 10px;">
							...
							<div class="form-group justify-content-center">
								<label class="col-md-2 control-label">힐링서비스<br>효과평가
								</label> <label class="btn btn-default" style="margin-top: 10px;">
							...
							<div class="form-group justify-content-center">
								<label class="col-md-2 control-label">자율신경검사<br>효과평가
								</label> <label class="btn btn-default" style="margin-top: 10px;">
							...
							<div class="form-group justify-content-center">
								...
								<div class="col-md-10">
									<textarea id="story" name="program_opinion"
							...
							<div class="form-group justify-content-center">
								...
								<div class="col-md-10">
									<textarea id="story" name="service_opinion"
										class="form-control" style="font-size: 13pt" rows="7"
										cols="100"></textarea>
								</div>
							</div>
							...
							<div class="form-group justify-content-center">
								...
								<div class="col-md-10">
									<textarea id="story" name="overall_opinion"
										class="form-control" style="font-size: 13pt" rows="7"
										cols="100"></textarea>
								</div>
							</div>
								...
								<div class="col-md-10">
									...
									<div class="col-md-6"
										...
										<textarea id="instructor_details" name="instructor_details"
											class="form-control col-md-3" style="font-size: 13pt"
											rows="2" cols="200"></textarea>
									</div>
								</div>
								<div>
									<hr />
