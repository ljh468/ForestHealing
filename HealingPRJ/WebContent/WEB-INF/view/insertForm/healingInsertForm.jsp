	...
	<script type="text/javascript">
		function add_div() {
			...
			let new_div = '<div class="insertForm" style="width: 2250px; height: 40px;" name="form-main" id="child'
			    ...
			    + `<%for(int j = 0; j < groupMargin.length; j++) { %><div style="width: 60px; float: left; margin-right: <%=groupMargin[j]%>px;"><input class="form-control" type="number" name="form-score<%=j+1 %>" placeholder="점수"></div><% } %></div>`;
