				...
				<div class="panel panel-default chat">
					...
					<div class="panel-body" style="overflow-x: scroll; height: auto; overflow-y: hidden;">
						...
						<%
							for (int i = 0; i < 20; i++) {
						%>
						<div class="insertForm" style="width: 5100px; height: 60px;" name="form-main" id="child<%=i%>">
							...
							<div class='listH' style="width: 130px; float: left; margin-right: 10px;">-</div>
							
							<div style="width: 60px; float: left; margin-right: 10px;">
								<input class="form-control form-num9" data-id="<%=i%>" data-type="listI" name='form-num9' placeholder="수치">
							</div>
							<div class='listI' style="width: 130px; float: left; margin-right: 10px;">-</div>
							
							<div style="width: 60px; float: left; margin-right: 10px;">
								<input class="form-control form-num10" data-id="<%=i%>" data-type="listJ" name='form-num10' placeholder="수치">
							</div>
							<div class='listJ' style="width: 130px; float: left; margin-right: 10px;">-</div>
						</div>
						<%
							}
						%>
