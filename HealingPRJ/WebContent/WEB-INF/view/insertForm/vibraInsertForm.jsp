						...
						<div id="parent">
							...
							<div class="insertForm" style="width: 2400px; height: 45px;" name="form-main" id="child<%=i%>">
								...
								<div style="width: 95px; float: left; margin-right: 5px;">
									<input class="form-control form-num1" data-id="<%=i%>" data-type="listA" type="number" name="form-num1" placeholder="수치">
								</div>
								<div class="listA state" style="width: 45px; float: left; margin-right: 5px;">&nbsp;</div>
								
								<div style="width: 95px; float: left; margin-right: 5px;">
									<input class="form-control form-num2" data-id="<%=i%>" data-type="listB" type="number" name="form-num2" placeholder="수치">
								</div>
								<div class="listB state" style="width: 45px; float: left; margin-right: 5px;">&nbsp;</div>
								
								<div style="width: 95px; float: left; margin-right: 5px;">
									<input class="form-control form-num3" data-id="<%=i%>" data-type="listC" type="number" name="form-num3" placeholder="수치">
								</div>
								<div class="listC state" style="width: 45px; float: left; margin-right: 5px;">&nbsp;</div>
								
								<div style="width: 95px; float: left; margin-right: 5px;">
									<input class="form-control form-num4" data-id="<%=i%>" data-type="listD" type="number" name="form-num4" placeholder="수치">
								</div>
								<div class="listD state" style="width: 45px; float: left; margin-right: 5px;">&nbsp;</div>
								
								<div style="width: 95px; float: left; margin-right: 5px;">
									<input class="form-control form-num5" data-id="<%=i%>" data-type="listE" type="number" name="form-num5" placeholder="수치">
								</div>
								<div class="listE state" style="width: 45px; float: left; margin-right: 5px;">&nbsp;</div>
								
								<div style="width: 95px; float: left; margin-right: 5px;">
									<input class="form-control form-num6" data-id="<%=i%>" data-type="listF" type="number" name="form-num6" placeholder="수치">
								</div>
								<div class="listF state" style="width: 45px; float: left; margin-right: 5px;">&nbsp;</div>
								
								<div style="width: 95px; float: left; margin-right: 5px;">
									<input class="form-control form-num7" data-id="<%=i%>" data-type="listG" type="number" name="form-num7" placeholder="수치">
								</div>
								<div class="listG state" style="width: 45px; float: left; margin-right: 5px;">&nbsp;</div>
								
								<div style="width: 95px; float: left; margin-right: 5px;">
									<input class="form-control form-num8" data-id="<%=i%>" data-type="listH" type="number" name="form-num8" placeholder="수치">
								</div>
								<div class="listH state" style="width: 45px; float: left; margin-right: 5px;">&nbsp;</div>
								
								<div style="width: 95px; float: left; margin-right: 5px;">
									<input class="form-control form-num9" data-id="<%=i%>" data-type="listI" type="number" name="form-num9" placeholder="수치">
								</div>
								<div class="listI state" style="width: 45px; float: left; margin-right: 5px;">&nbsp;</div>
								
								<div style="width: 95px; float: left; margin-right: 5px;">
									<input class="form-control form-num10" data-id="<%=i%>" data-type="listJ" type="number" name="form-num10" placeholder="수치">
								</div>
