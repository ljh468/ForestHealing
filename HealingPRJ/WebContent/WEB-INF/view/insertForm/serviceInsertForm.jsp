				...
				<div class="panel panel-default chat">
					...
					<div class="panel-body" style="overflow-x: scroll; height: auto; overflow-y: hidden;">
						...
						<div style="width: 2380px; height: 70px">
							<div
								style="width: 60px; float: left; margin-right: 10px; margin-left:30px; text-align: center; -webkit-text-emphasis-style: open;">
						...
						<%
							for (int i = 0; i < 20; i++) {
						%>
							<div class="insertForm" style="width: 2380px; height: 60px" name="form-main" id="child<%=i%>">
