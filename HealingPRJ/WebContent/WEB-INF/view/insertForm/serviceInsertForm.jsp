			...
			<div class="col-md-12">
				<div class="col-md-3">
					<div class="form-group">
						<label>입력양식</label> <select class="form-control" onchange="location.href=this.value">
							<option value="http://localhost:9000/insertForm/serviceInsertForm.do" selected>서비스환경 만족도</option>
