...
<body>
	...
	<div
		...
		<div style=" display: table-row; width: 950px; border: 1px solid black;">
			<div style="display: table-cell; width: 100px; height:60px; border-right: 1px solid black;"><br>주제어 1</div>
			<div style="display: table-cell; width: 100px; height: 60px; border-right: 1px solid black;"><br>주제어 2</div>
			<div style="display: table-cell; width: 100px; height: 60px; border-right: 1px solid black;"><br>주제어3</div>
			<div style="display: table-cell;">
				<div style="width: 201px; line-height:30px;height: 30px; border-bottom: 1px solid black; border-right: 1px solid black;">강사</div>
				<div style="display: table-cell;">
			...
			<div style="display: table-cell;">
				<div style="width: 201px; line-height:30px;height: 30px; border-bottom: 1px solid black; border-right: 1px solid black;">내용구성</div>
				<div style="display: table-cell;">
			...
			<div style="display: table-cell;">
				<div style="width: 200 px; line-height:30px;height: 30px; border-bottom: 1px solid black; border-right: 1px solid black;">효과성</div>
				<div style="display: table-cell;">
			...
			<div style="display: table-cell; width: 100px; height: 60px; "><br>평균</div>
		</div>
		<!-- for문 실행 -->
		 <div style="display: table-row; width: 950px; border: 1px solid black;">
			<div style="display: table-cell; width: 100px; line-height:30px;height: 30px; border-right: 1px solid black;">주제어 1</div>
			<div style="display: table-cell; width: 100px; line-height:30px;height: 30px; border-right: 1px solid black;">주제어 2</div>
			<div style="display: table-cell; width: 100px; line-height:30px;height: 30px; border-right: 1px solid black;">주제어 3</div>
			<div>
				<div style="display: table-cell;">
					<div style="display: table-cell; width: 50px; line-height:30px;height: 30px; border-right: 1px solid black;">전문성</div>
					<div style="display: table-cell; width: 50px; line-height:30px;height: 30px; border-right: 1px solid black;">성실성</div>
			...
			<div style="display: table-cell; width: 100px; height: 30px; border-right: 1px solid black;">평균</div>
		</div> 
	</div>
</body>
</html>